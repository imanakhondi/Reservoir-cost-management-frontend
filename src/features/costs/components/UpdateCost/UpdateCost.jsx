...
const UpdateCost = () => {
  const service = useUpdateCostPageService();
        ...
        <div className="bg-white rounded section-body p-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
            ...
            <InputSelect
              ...
              required
            />
            <InputText field="cost" required />
            <InputDatePicker field="costDate" required />
          </div>
          ...
          <div className="">
            <InputTextarea field="costDescription" defaultValue={formData.costDescription} />
          </div>
        </div>
